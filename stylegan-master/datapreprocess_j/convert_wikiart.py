...
def _get_filenames_and_classes(dataset_dir):
  ...
  for directory in directories:
    photo_filenames.append(directory)
...
def _get_dataset_filename(dataset_dir, shard_id):
  output_filename = 'wikiart_%05d-of-%05d.tfrecord' % (shard_id, _NUM_SHARDS)
...
def run(input_dataset_dir, dataset_dir):
  ...
  _convert_dataset("a", photo_filenames, class_names_to_ids, dataset_dir)
  '''
